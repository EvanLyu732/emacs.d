...
** Blog
TODO
   * using org-publish for building blog (elisp require)
   * use this link https://www.reddit.com/r/emacs/comments/ng9hyq/good_tutorials_on_orgpublish/ and this link https://orgmode.org/worg/org-tutorials/org-publish-html-tutorial.html#org376932a
   * this link is fun https://diego.codes/post/2019-reading-list/
...
(setq org-publish-project-alist
      '(("posts"
         :base-directory "~/Org/Blog/" ;; original posts location
         :base-extension "org"
         :publishing-directory "~/Org/public/"
         :recursive t ;; recursive generate data
